...
**WEX** - Quality Assurance Specialist II  
...
**CESAR** - Engenheiro de Testes Júnior  
Recife, Pernambuco, Brasil  
out de 2021 - jun de 2023 · 1 ano 9 meses
- Análise, modelagem, implementação e execução de testes manuais e automáticos
- Automação de testes com Cypress ou Selenium

**Samsung Brasil** - Engenheiro de Testes Júnior  
Campinas e Região, Brasil  
jun de 2019 - out de 2021 · 2 anos 5 meses
- Criação de casos de testes manuais e automáticos para o assistente inteligente Bixby
- Acompanhamento e reporte de bugs

**Motorola Mobility** - Estagiário de Engenharia de Testes  
Campinas e Região, Brasil  
jan de 2017 - dez de 2017
- Análise de projetos e geração de relatórios
- Contribuição em implementação de projetos de hardware e software

### Vamos conversar sobre

- Massa Fresca, Risoto, Carne e Cerveja 🍺🥣
- Convergência Homem Máquina e a Singularidade 🤖
- Cafés especiais ☕
...
- **Bachelors Degree in Telecomunication Engineering by INATEL [2018]**
...
**CESAR** - Junior Test Engineer  
Recife, Pernambuco, Brazil  
Oct 2021 - Jun 2023 · 1 year 9 months
- Analysis, modeling, implementation, and execution of manual and automated tests
- Test automation with Cypress or Selenium

**Samsung Brazil** - Junior Test Engineer  
Campinas Region, Brazil  
Jun 2019 - Oct 2021 · 2 years 5 months
- Creating manual and automated test cases for the Bixby intelligent assistant
- Tracking and reporting bugs, ensuring product quality and reliability

**Motorola Mobility** - Test Engineering Intern  
Campinas Region, Brazil  
Jan 2017 - Dec 2017
- Assisted in project analysis and generating graphs and reports
- Contributed to the implementation and enhancement of hardware and software projects
